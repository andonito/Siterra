            ...
            <div className="md:col-span-4 space-y-4">
              ...
              <div className="flex gap-3">
                <a 
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-10 h-10 rounded-xl bg-white/[0.03] hover:bg-white/[0.08] border border-white/10 hover:border-white/20 flex items-center justify-center text-zinc-400 hover:text-white transition-all shadow-md group"
                >
                  <Lucide.Instagram className="w-5 h-5 group-hover:scale-110 transition-transform" />
                </a>
                <a 
                  ...
                  className="w-10 h-10 rounded-xl bg-white/[0.03] hover:bg-white/[0.08] border border-white/10 hover:border-white/20 flex items-center justify-center text-zinc-400 hover:text-white transition-all shadow-md group"
                >
                  <Lucide.Facebook className="w-5 h-5 group-hover:scale-110 transition-transform" />
                </a>
              </div>
            </div>
